...
const dummyCn = (...inputs: (string | undefined | null | false)[]) => {
          ...
          <div className="fixed inset-0 z-[9999] flex items-start sm:items-center justify-center p-4">
            ...
            <motion.div
              ...
              className={cnFunction(
                `relative z-[9999] w-full max-w-lg rounded-2xl border border-slate-800
                bg-slate-900 p-6 shadow-2xl max-h-[80vh] top-20 lg:top-10 xl:top-4 overflow-y-auto text-slate-100`,
                className
              )}
              role="dialog"
              aria-modal="true"
...
const DialogDescription = React.forwardRef<HTMLParagraphElement, React.HTMLAttributes<HTMLParagraphElement>>(
  ({ className, ...props }, ref) => (
    <p
      ref={ref}
      className={cnFunction("text-sm text-slate-400", className)}
      {...props}
    />
  )
);
