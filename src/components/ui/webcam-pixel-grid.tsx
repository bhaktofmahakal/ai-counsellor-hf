        ...
        <div className={cn("relative w-full h-full", className)}>
            ...
            {error && showErrorPopup && (
                <div className="fixed bottom-6 right-6 z-[100] animate-in fade-in slide-in-from-bottom-2 duration-300">
                    <div className="relative flex items-start gap-3 rounded-2xl border border-white/10 bg-black/90 p-5 backdrop-blur-2xl shadow-3xl max-w-sm">
                        {/* Close button */}
                        <button
            ...
            {error && !showErrorPopup && (
                <button
                    ...
                    className="fixed bottom-6 right-6 z-[100] w-12 h-12 rounded-full bg-black/80 border border-white/10 backdrop-blur-2xl flex items-center justify-center text-white/40 hover:text-white/80 hover:bg-black transition-all hover:scale-110 shadow-3xl group"
                    title="Camera access required for interactive effect"
                >
                    <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M15 10l4.553-2.276A1 1 0 0121 8.618v6.764a1 1 0 01-1.447.894L15 14M5 18h8a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v8a2 2 0 002 2z" />
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 3l18 18" className="opacity-40" stroke="currentColor" />
                    </svg>
                </button>
            )}
        </div>
