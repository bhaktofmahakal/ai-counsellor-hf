...
import { FileSearch, ClipboardCheck, TrendingUp, Sparkles, ArrowRight } from 'lucide-react';
            ...
            <div className="relative z-10 max-w-7xl mx-auto px-6 pt-32 pb-20">
                ...
                >
                    <div className="inline-flex items-center gap-3 px-4 py-2 rounded-full bg-purple-500/10 border border-purple-500/20 text-purple-400 backdrop-blur-md">
                        ...
                        <span className="text-xs font-bold tracking-wider uppercase">Expert Review</span>
                    </div>

                    <h1 className="text-5xl md:text-7xl font-display font-black text-white tracking-tight leading-[1]">
                        Strategy <br />
                        <span className="bg-clip-text text-transparent bg-gradient-to-r from-purple-400 via-pink-400 to-blue-400">Audit</span>
                    </h1>

                    <p className="text-lg md:text-xl text-neutral-400 font-light max-w-2xl mx-auto leading-relaxed">
                        Comprehensive review of your application strategy. Get <span className="text-white font-semibold">actionable insights</span> to maximize your admission chances.
                    </p>
                </motion.div>
                    ...
                    {[
                        {
                            ...
                            desc: "AI-powered review of your SOP, LORs, and resume against successful admit profiles.",
                            gradient: "from-purple-500/20"
                        },
                        {
                            icon: ClipboardCheck,
                            title: "Profile Gaps",
                            desc: "Identify missing elements and weak points in your application before submission.",
                            gradient: "from-pink-500/20"
                        },
                        {
                            icon: TrendingUp,
                            title: "Optimization Plan",
                            desc: "Receive a customized roadmap to strengthen your profile and improve outcomes.",
                        ...
                        <motion.div
                            ...
                            className={`p-8 md:p-10 rounded-2xl md:rounded-3xl bg-gradient-to-br ${item.gradient} to-transparent border border-white/10 space-y-4 md:space-y-6 group hover:border-white/20 transition-all hover:scale-105`}
                        >
                            ...
                            <h3 className="text-xl md:text-2xl font-display font-bold text-white tracking-tight">{item.title}</h3>
                            <p className="text-neutral-400 font-light text-sm md:text-base leading-relaxed">{item.desc}</p>
                        </motion.div>
                    ))}
                </div>
                ...
                <motion.div
                    initial={{ opacity: 0, y: 20 }}
                    whileInView={{ opacity: 1, y: 0 }}
                    className="p-8 md:p-16 rounded-[2rem] md:rounded-[3rem] bg-gradient-to-br from-purple-500/10 via-pink-500/10 to-blue-500/10 border border-white/10 relative overflow-hidden"
                >
                    ...
                    <div className="relative z-10 space-y-12">
                        <div className="text-center space-y-4">
                            ...
                            <p className="text-neutral-400 font-light text-lg max-w-2xl mx-auto">
                                A complete audit report with actionable recommendations
                            </p>
                        </div>

                        <div className="grid md:grid-cols-2 gap-6">
                            {[
                                "Detailed SOP feedback with improvement suggestions",
                                "LOR strength analysis and recommender selection tips",
                                "Resume optimization for academic applications",
                                "Profile positioning strategy for target universities",
                                "Timeline audit to ensure you meet all deadlines",
                                ...
                                <div key={i} className="flex items-start gap-4 p-6 rounded-2xl bg-white/[0.02] border border-white/5">
                                    <div className="h-6 w-6 shrink-0 rounded-full bg-purple-500/20 border border-purple-500/30 flex items-center justify-center mt-0.5">
