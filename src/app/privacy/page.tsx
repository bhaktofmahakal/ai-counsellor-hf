        ...
        <div className="min-h-screen bg-black text-white selection:bg-white/10 relative overflow-hidden">
            ...
            <div className="max-w-3xl mx-auto px-6 py-16 md:py-24 relative z-10">
                <div className="space-y-4 mb-12 md:mb-16">
                    ...
                    <h1 className="text-4xl md:text-5xl font-display font-black tracking-tight">Privacy Policy</h1>
                    <p className="text-neutral-500 font-medium">Last Updated: January 28, 2025</p>
                </div>

                <div className="prose prose-invert max-w-none space-y-12">
                    <section className="space-y-4">
                        <h2 className="text-2xl font-bold text-white uppercase tracking-tight">1. Data Sovereignty</h2>
                        <p className="text-neutral-400 leading-relaxed font-light italic">
                            Your academic and personal data is your property. AI Counsellor acts as a processing intelligence, not a data broker. We do not sell your transition maps or profile metrics to third-party institutions.
                        </p>
                    </section>

                    <section className="space-y-4">
                        <h2 className="text-2xl font-bold text-white uppercase tracking-tight">2. Intelligence Processing</h2>
                        <p className="text-neutral-400 leading-relaxed font-light italic">
                            We utilize encrypted neural networks to analyze your profile. This analysis happens in isolated environments. Your session data is used exclusively to refine your university match accuracy.
                        </p>
                    </section>

                    <section className="space-y-4">
                        <h2 className="text-2xl font-bold text-white uppercase tracking-tight">3. Security</h2>
                        <p className="text-neutral-400 leading-relaxed font-light italic">
                            Military-grade AES-256 encryption is applied to all stored credentials. Our architecture is designed to be audit-ready and follows global compliance standards for educational guidance.
                        </p>
                    </section>
                </div>
            </div>
