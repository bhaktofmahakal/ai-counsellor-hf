...
import { MessagesSquare, Share2, Users2, Sparkles, ArrowRight, Lock } from 'lucide-react';
    ...
    return (
        <div className="min-h-screen w-full bg-black relative text-white">
            ...
            <div className="relative z-10 max-w-7xl mx-auto px-6 pt-32 pb-20">
                ...
                >
                    <div className="inline-flex items-center gap-3 px-4 py-2 rounded-full bg-indigo-500/10 border border-indigo-500/20 text-indigo-400 backdrop-blur-md">
                        <Users2 className="h-4 w-4" />
                        <span className="text-xs font-bold tracking-wider uppercase">Private Network</span>
                    </div>

                    <h1 className="text-5xl md:text-7xl font-display font-black text-white tracking-tight leading-[1]">
                        The Collective <br />
                        <span className="bg-clip-text text-transparent bg-gradient-to-r from-indigo-400 via-purple-400 to-pink-400">Network</span>
                    </h1>

                    <p className="text-xl text-neutral-400 font-light max-w-2xl mx-auto leading-relaxed">
                        A private collective of <span className="text-white font-semibold">5,000+ ambitious students</span> sharing visa interview hacks, campus realities, and peer-to-peer audits.
                    </p>
                </motion.div>
                    ...
                    {[
                        {
                            ...
                            desc: "Discord-integrated channels for instant updates on visa wait times and faculty changes.",
                            gradient: "from-indigo-500/20"
                        },
                        {
                            icon: Users2,
                            title: "Peer Networks",
                            desc: "Connect with students already at your target university before you land.",
                            gradient: "from-purple-500/20"
                        },
                        {
                            icon: Share2,
                            title: "Resource Vault",
                            desc: "A crowdsourced library of successful SOPs and LOR templates.",
                        ...
                        <motion.div
                            ...
                            className={`p-8 md:p-10 rounded-2xl md:rounded-3xl bg-gradient-to-br ${item.gradient} to-transparent border border-white/10 space-y-6 group hover:border-white/20 transition-all hover:scale-105`}
                        >
                ...
                <motion.div
                    initial={{ opacity: 0, y: 20 }}
                    whileInView={{ opacity: 1, y: 0 }}
                    className="p-8 md:p-16 rounded-[2rem] md:rounded-[3rem] bg-gradient-to-br from-indigo-500/10 via-purple-500/10 to-pink-500/10 border border-white/10 text-center relative overflow-hidden"
                >
                    ...
                    <div className="relative z-10 space-y-8">
                        <div className="inline-flex items-center gap-3 px-4 py-2 rounded-full bg-black/40 border border-white/10 backdrop-blur-md">
                            ...
                            <span className="text-xs font-bold text-neutral-400 uppercase tracking-wider">Members Only</span>
                        </div>
                        ...
                        <p className="text-neutral-400 max-w-md mx-auto font-light text-lg">
                            Access is restricted to active AI Counsellor users. Initialize your profile to gain credentials.
                        </p>
                        ...
                        <div className="pt-8 flex flex-wrap items-center justify-center gap-8 md:gap-12 text-center">
                            <div>
                                <div className="text-3xl md:text-4xl font-display font-black text-white mb-1">5,000+</div>
                                <div className="text-[10px] md:text-xs uppercase tracking-wider text-neutral-500 font-bold">Active Members</div>
                            </div>
                            <div className="hidden md:block h-12 w-px bg-white/10" />
                            <div>
                                <div className="text-3xl md:text-4xl font-display font-black text-white mb-1">120+</div>
                                <div className="text-[10px] md:text-xs uppercase tracking-wider text-neutral-500 font-bold">Countries</div>
                            </div>
                            <div className="hidden md:block h-12 w-px bg-white/10" />
                            <div>
                                <div className="text-3xl md:text-4xl font-display font-black text-white mb-1">24/7</div>
                                <div className="text-[10px] md:text-xs uppercase tracking-wider text-neutral-500 font-bold">Support</div>
                            </div>
                        </div>
                    </div>
                </motion.div>
