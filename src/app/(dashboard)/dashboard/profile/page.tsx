...
export default function ProfilePage() {
  ...
  const completionItems = [
    { label: 'Basic Information', completed: !!profileData.name && !!profileData.email },
    { label: 'Academic Background', completed: !!profileData.education && !!profileData.degree },
    { label: 'Study Goals', completed: !!profileData.studyGoal },
    { label: 'Budget Planning', completed: parseInt(profileData.budgetMax) > 0 },
    { label: 'Exam Scores', completed: !!profileData.examScores },
  ];
